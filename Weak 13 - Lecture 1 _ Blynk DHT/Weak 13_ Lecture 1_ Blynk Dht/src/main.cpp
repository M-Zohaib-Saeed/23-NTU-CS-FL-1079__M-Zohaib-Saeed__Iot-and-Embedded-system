...
#define BLYNK_TEMPLATE_ID "TMPL65nKele3c"
#define BLYNK_TEMPLATE_NAME "Dht by Zohaib"
#define BLYNK_AUTH_TOKEN "BbCJ8SuSY-AVZUEJIjl_ya1BD3Oqm_j9"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
